...
const Home = () => {
  ...
  const makePrediction = (e) => {
    ...
    axios.post('http://localhost:8080/patients', patient, { withCredentials: true })
      .then(res => {
  ...
  const deletePatient = (confirm) => {
    if(!confirm)
      return
    axios.delete(`http://localhost:8080/patient/${patientToDelete}`, { withCredentials: true })
      .then((res) => {
